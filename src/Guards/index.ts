...
export declare type ArrayGuard<T> = Extract<T, Array<any>> extends never
  ? Array<unknown>
  : Extract<T, Array<any>>;
export declare type PromiseGuard<T> = Extract<T, Promise<any>> extends never
  ? Promise<unknown>
  : Extract<T, Promise<any>>;
export declare type ObjectGuard<T> = Exclude<
  Extract<T, object>,
  Function | Array<any>
> extends never
  ? { [k: string]: unknown }
