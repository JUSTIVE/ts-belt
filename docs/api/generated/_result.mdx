...
```ts
function all<T extends readonly [...Result<any, any>[]]>(xs: readonly [...T]): Result<TypeOfResultArray<T>, globalThis.Error>
```
...
```ts
function filter<A, B>(result: Result<A, B>, predicateFn: (value: A) => boolean): Result<A, B | globalThis.Error>
function filter<A, B>(predicateFn: (value: A) => boolean): (result: Result<A, B>) => Result<A, B | globalThis.Error>
```
...
```ts
function flatMap<A, B, C, D = B>(result: Result<A, B>, mapFn: (value: A) => Result<C, D>): Result<C, B | D>
function flatMap<A, B, C, D = B>(mapFn: (value: A) => Result<C, D>): (result: Result<A, B>) => Result<C, B | D>
```
...
```ts
function fold<A, B, C>(result: Result<A, B>, okFn: (value: A) => C, errorFn: (error: B) => C): C
function fold<A, B, C>(okFn: (value: A) => C, errorFn: (error: B) => C): (result: Result<A, B>) => C
```
...
```ts
function fromExecution<A>(fn: () => A): Result<NonNullable<A>, globalThis.Error>
```
...
R.fromExecution(parseJSON<User>(badJSON)) // → Error(
...
```ts
function fromFalsy<A, B>(value: A, errorValue: B): Result<NonNullable<A>, B>
function fromFalsy<A, B>(errorValue: B): (value: A) => Result<NonNullable<A>, B>
```
...
```ts
function fromNullable<A, B>(value: A, errorValue: B): Result<NonNullable<A>, B>
function fromNullable<A, B>(errorValue: B): (value: A) => Result<NonNullable<A>, B>
```
...
```ts
function fromPredicate<A, B>(value: A, predicateFn: (value: NonNullable<A>) => boolean, errorValue: B): Result<NonNullable<A>, B>
function fromPredicate<A, B>(predicateFn: (value: NonNullable<A>) => boolean, errorValue: B): (value: A) => Result<NonNullable<A>, B>
```
...
```ts
function fromPromise<A>(promise: Promise<A>): Promise<Result<NonNullable<A>, globalThis.Error>>
```
...
```ts
function getWithDefault<A, B>(result: Result<A, B>, defaultValue: A): A
function getWithDefault<A, B>(defaultValue: A): (result: Result<A, B>) => A
```
...
```ts
function handleError<A, B>(result: Result<A, B>, mapFn: (err: B) => A): Result<A, void>
function handleError<A, B>(mapFn: (err: B) => A): (result: Result<A, B>) => Result<A, void>
```
...
```ts
function makeError<A, B>(value: B): Result<A, B>
```
...
```ts
function makeOk<A, B>(value: A): Result<A, B>
```
...
```ts
function map<A, B, C>(result: Result<A, B>, mapFn: (value: A) => C): Result<C, B>
function map<A, B, C>(mapFn: (value: A) => C): (result: Result<A, B>) => Result<C, B>
```
...
```ts
function mapError<A, B, C>(result: Result<A, B>, mapFn: (err: B) => C): Result<A, C>
function mapError<A, B, C>(mapFn: (err: B) => C): (result: Result<A, B>) => Result<A, C>
```
...
```ts
function mapWithDefault<A, B, C>(result: Result<A, B>, defaultValue: C, mapFn: (value: A) => C): C
function mapWithDefault<A, B, C>(defaultValue: C, mapFn: (value: A) => C): (result: Result<A, B>) => C
```
...
```ts
function recover<A, B>(result: Result<A, B>, defaultValue: A): Result<A, B>
function recover<A, B>(defaultValue: A): (result: Result<A, B>) => Result<A, B>
```
