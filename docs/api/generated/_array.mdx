...
```ts
function at<A>(xs: Array<A>, index: number): undefined | A
function at<A>(index: number): (xs: Array<A>) => undefined | A
```
...
```ts
function deepFlat<A>(xs: Array<A>): Array<UnpackArray<A>>
```
...
```ts
function dropExactly<A>(xs: Array<A>, n: number): undefined | Array<A>
function dropExactly<A>(n: number): (xs: Array<A>) => undefined | Array<A>
```
...
```ts
function filterMap<A, B>(xs: Array<A>, predicateFn: (_1: A) => undefined | B): Array<B>
function filterMap<A, B>(predicateFn: (_1: A) => undefined | B): (xs: Array<A>) => Array<B>
```
...
```ts
function find<A>(xs: Array<A>, predicateFn: (_1: A) => boolean): undefined | A
function find<A>(predicateFn: (_1: A) => boolean): (xs: Array<A>) => undefined | A
```
...
```ts
function flatMap<A, B>(xs: Array<A>, fn: (value: A) => B | Array<B>): Array<B>
function flatMap<A, B>(fn: (value: A) => B | Array<B>): (xs: Array<A>) => Array<B>
```
...
```ts
function get<A>(xs: Array<A>, index: number): undefined | A
function get<A>(index: number): (xs: Array<A>) => undefined | A
```
...
```ts
function getBy<A>(xs: Array<A>, predicateFn: (_1: A) => boolean): undefined | A
function getBy<A>(predicateFn: (_1: A) => boolean): (xs: Array<A>) => undefined | A
```
...
```ts
function getIndexBy<A>(xs: Array<A>, predicateFn: (_1: A) => boolean): undefined | number
function getIndexBy<A>(predicateFn: (_1: A) => boolean): (xs: Array<A>) => undefined | number
```
...
```ts
function getUndefined<A>(xs: Array<A>, index: number): undefined | A
function getUndefined<A>(index: number): (xs: Array<A>) => undefined | A
```
...
```ts
function groupBy<A>(xs: Array<A>, groupFn: (item: A) => PropertyKey): Record<PropertyKey, readonly [A, ...A[]]>
function groupBy<A>(groupFn: (item: A) => PropertyKey): (xs: Array<A>) => Record<PropertyKey, readonly [A, ...A[]]>
```
...
```ts
function head<A>(xs: Array<A>): undefined | A
```
...
```ts
function init<A>(xs: Array<A>): undefined | Array<A>
```
...
```ts
function keepMap<A, B>(xs: Array<A>, predicateFn: (_1: A) => undefined | B): Array<B>
function keepMap<A, B>(predicateFn: (_1: A) => undefined | B): (xs: Array<A>) => Array<B>
```
...
```ts
function last<A>(xs: Array<A>): undefined | A
```
...
```ts
A.partition([1, 2, 3, 4], (value) => value > 2) // → [
    [3, 4],
    [1, 2],
]
pipe([1, "hello", 2, "world"], A.partition(G.isString)) // → [
    ["hello", "world"],
    [1, 2],
]
```
...
```ts
function sample<A>(xs: Array<A>): A
```
...
```ts
function splitAt<A>(xs: Array<A>, offset: number): undefined | readonly [Array<A>, Array<A>]
function splitAt<A>(offset: number): (xs: Array<A>) => undefined | readonly [Array<A>, Array<A>]
```
...
```ts
function tail<A>(xs: Array<A>): undefined | Array<A>
```
...
```ts
function takeExactly<A>(xs: Array<A>, n: number): undefined | Array<A>
function takeExactly<A>(n: number): (xs: Array<A>) => undefined | Array<A>
```
...
```ts
function uncons<A>(xs: Array<A>): undefined | readonly [A, Array<A>]
```
