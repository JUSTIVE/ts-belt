...
```ts
function endsWith<A extends string>(str: string, substr: A): str is `${string}${A}`
function endsWith<A extends string>(substr: A): (str: string) => str is `${string}${A}`
```
...
```ts
function get(str: string, n: number): undefined | string
function get(n: number): (str: string) => undefined | string
```
...
```ts
function head(str: string): undefined | string
```
...
```ts
function indexOf(searchValue: string): (str: string) => undefined | number
function indexOf(str: string, searchValue: string): undefined | number
```
...
```ts
function last(str: string): undefined | string
```
...
```ts
function lastIndexOf(searchValue: string): (str: string) => undefined | number
function lastIndexOf(str: string, searchValue: string): undefined | number
```
...
```ts
function match(str: string, regex: RegExp): undefined | Array<undefined | string>
function match(regex: RegExp): (str: string) => undefined | Array<undefined | string>
```
...
```ts
function search(str: string, regex: RegExp): undefined | number
function search(regex: RegExp): (str: string) => undefined | number
```
...
```ts
function splitByRe(str: string, regex: RegExp): Array<undefined | string>
function splitByRe(regex: RegExp): (str: string) => Array<undefined | string>
```
...
```ts
function startsWith<A extends string>(str: string, substr: A): str is `${A}${string}`
function startsWith<A extends string>(substr: A): (str: string) => str is `${A}${string}`
```
